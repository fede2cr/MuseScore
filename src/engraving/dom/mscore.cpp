...
std::string MScore::errorToString(MsError err)
{
    ...
    case MsError::BASSLINE_REQUIRES_CHORD_SYMBOL: return "BASSLINE_REQUIRES_CHORD_SYMBOL";
    case MsError::BASSLINE_INVALID_PATTERN: return "BASSLINE_INVALID_PATTERN";
